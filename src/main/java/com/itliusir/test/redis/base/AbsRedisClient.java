...
//            jedis.lpush(key, SerializeUtil.toJsonString(list.toArray(new String[list.size()])));
    ...
    @Override
    public long expireKey(String key, int expire) throws Exception {
        JedisCommands jedis = null;
        try {
            jedis = getResource();
    ...
    @Override
    public long pexpireAtKey(String key, long timestamp) throws Exception {
        JedisCommands jedis = null;
        try {
            jedis = getResource();
    ...
    @Override
    public <T> long lpush(String key, T t) throws Exception {
        JedisCommands jedis = null;
        try {
            jedis = getResource();
            return jedis.lpush(key, SerializeUtil.toJsonString(t));
        } catch (Exception e) {
            logger.error(e);
            throw e;
        } finally {
    ...
    @Override
    public long lpushString(String key, String... values) throws Exception {
        JedisCommands jedis = null;
        try {
            jedis = getResource();
    ...
    @Override
    public long rpushString(String key, String value) throws Exception {
        JedisCommands jedis = null;
        try {
            jedis = getResource();
    ...
    @Override
    public <T> long hsetNX(String key, String field, T value) throws Exception {
        JedisCommands jedis = null;
        try {
            jedis = getResource();
            return jedis.hsetnx(key, field, (String.class == value.getClass()) ? (String) value : SerializeUtil.toJsonString(value));
        } catch (Exception e) {
            logger.error(e);
            throw e;
        } finally {
    ...
    @Override
    public <T> long setNX(String key, T value) throws Exception {
        JedisCommands jedis = null;
        try {
            jedis = getResource();
            return jedis.setnx(key, (String.class == value.getClass()) ? (String) value : SerializeUtil.toJsonString(value));
        } catch (Exception e) {
            logger.error(e);
            throw e;
        } finally {
