...
public interface IRedis {
     ...
     * @throws Exception
     */
    <T> long lpush(String key, T t) throws Exception;
     ...
     * @throws Exception
     */
    long lpushString(String key, String... values) throws Exception;
     ...
     * @throws Exception
     */
    long expireKey(String key, int expire) throws Exception;


    long pexpireAtKey(String key, long timestamp) throws Exception;

    void close(JedisCommands jd) throws Exception;

    long rpushString(String key, String value) throws Exception;
    ...
    <T> long setNX(String key, T value) throws Exception;

    <T> long hsetNX(String key, String field, T value) throws Exception;
}
